...
function template_main()
{
	...
	echo '
		<div class="cat_bar">
			<h3 class="catbg">
				<a href="', $scripturl, '?action=helpadmin;help=themes_manage" onclick="return reqOverlayDiv(this.href);" class="help"><i class="fa fa-question-circle fa-lg" title="', $txt['help'], '"></i></a>
...
function template_set_settings()
{
	...
	<div id="admin_form_wrapper">
		<form action="', $scripturl, '?action=admin;area=theme;sa=list;th=', $context['theme_settings']['theme_id'], '" method="post" accept-charset="', $context['character_set'], '">
			<div class="cat_bar">
				<h3 class="catbg">
					<a href="', $scripturl, '?action=helpadmin;help=theme_settings" onclick="return reqOverlayDiv(this.href);" class="help"><i class="fa fa-question-circle fa-lg" title="', $txt['help'], '"></i></a> ', $txt['theme_settings'], ' - ', $context['theme_settings']['name'], '
				</h3>
			</div>
			<div class="windowbg">';
	...
	if ($context['theme_settings']['theme_id'] != 1)
		echo '
				<div class="title_bar">
					<h3 class="titlebg">
						<i class="fa fa-user fa-lg"></i>', $txt['theme_edit'], '
					</h3>
				</div>
				<div class="windowbg">
					<ul>
	...
	echo '
				<div class="title_bar">
					<h3 class="titlebg">
						<i class="fa fa-user fa-lg"></i>', $txt['theme_url_config'], '
					</h3>
				</div>
				<dl class="settings">
					<dt>
	...
	if (!empty($context['theme_variants']))
	{
		echo '
				<div class="title_bar">
					<h3 class="titlebg">
						<i class="fa fa-user fa-lg"></i>', $txt['theme_variants'], '
					</h3>
				</div>
				<dl class="settings">
					<dt>
	...
	echo '
				<div class="title_bar">
					<h3 class="titlebg">
						<i class="fa fa-user fa-lg"></i>', $txt['theme_options'], '
					</h3>
				</div>
				<dl class="settings">';
