...
function template_main()
{
	...
	echo '
		<div class="cat_bar">
			<h3 class="catbg">
				<i class="fa fa-search fa-lg"></i>', $txt['set_parameters'], '
			</h3>
		</div>
				...
				<span class="floatright">';
					...
					else
					{
						if ($topic['quick_mod']['remove'])
							echo '
					<a href="', $scripturl, '?action=quickmod;board=' . $topic['board']['id'] . '.0;actions%5B', $topic['id'], '%5D=remove;', $context['session_var'], '=', $context['session_id'], '" class="you_sure"  title="', $txt['remove_topic'], '"><i class="fa fa-trash fa-lg"></i></a>';

						if ($topic['quick_mod']['lock'])
							echo '
					<a href="', $scripturl, '?action=quickmod;board=' . $topic['board']['id'] . '.0;actions%5B', $topic['id'], '%5D=lock;', $context['session_var'], '=', $context['session_id'], '" class="you_sure" title="', $topic['is_locked'] ? $txt['set_unlock'] : $txt['set_lock'], '"><i class="fa fa-', $topic['is_locked'] ? 'unlock' : 'lock' ,' fa-lg"></i></a>';
					...
					<br>';
						...
						if ($topic['quick_mod']['sticky'])
							echo '
					<a href="', $scripturl, '?action=quickmod;board=' . $topic['board']['id'] . '.0;actions%5B', $topic['id'], '%5D=sticky;', $context['session_var'], '=', $context['session_id'], '" class="you_sure" title="', $topic['is_sticky'] ? $txt['set_nonsticky'] : $txt['set_sticky'], '"><i class="fa fa-thumtack fa-lg"></i></a>';

						if ($topic['quick_mod']['move'])
							echo '
					<a href="', $scripturl, '?action=movetopic;topic=', $topic['id'], '.0" title="', $txt['move_topic'], '"><i class="fa fa-move fa-lg"></i></a>';
					}
