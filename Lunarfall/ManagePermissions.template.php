		...
		echo '
							<div class="padding">
								<p class="smalltext floatleft">
									...
									<i class="fa fa-check fa-lg green"></i>', $txt['permissions_post_moderation_allow'], '<br>
									<i class="fa fa-warning fa-lg yellow"></i>', $txt['permissions_post_moderation_moderate'], '<br>
									<i class="fa fa-minus-circle fa-lg red"></i> ', $txt['permissions_post_moderation_disallow'], '
								</p>
