...
function template_permission_index()
{
	...
	foreach ($context['groups'] as $group)
	{
		echo '
					<tr class="windowbg">
						<td>
							', !empty($group['help']) ? ' <a class="help" href="' . $scripturl . '?action=helpadmin;help=' . $group['help'] . '" onclick="return reqOverlayDiv(this.href);"><i class="fa fa-question-circle fa-lg" title="' . $txt['help'] . '"></i></a> ' : '<img class="icon" src="' . $settings['images_url'] . '/blank.png" alt="' . $txt['help'] . '">', '<span>', $group['name'], '</span>';
...
function template_inline_permissions()
{
	...
	echo '
											<fieldset id="', $context['current_permission'], '">
												<legend><a href="javascript:void(0);" onclick="document.getElementById(\'', $context['current_permission'], '\').style.display = \'none\';document.getElementById(\'', $context['current_permission'], '_groups_link\').style.display = \'block\'; return false;"><i class="fa toggle_up"></i> ', $txt['avatar_select_permission'], '</a></legend>';
	...
	echo '
											...
											<a href="javascript:void(0);" onclick="document.getElementById(\'', $context['current_permission'], '\').style.display = \'block\'; document.getElementById(\'', $context['current_permission'], '_groups_link\').style.display = \'none\'; return false;" id="', $context['current_permission'], '_groups_link" style="display: none;"><i class="fa toggle_down"></i> ', $txt['avatar_select_permission'], '</a>
	...
	if (!empty($modSettings['postmod_active']))
	{
		...
		echo '
							<div class="padding">
								<ul class="floatleft smalltext block">
									...
									<li><i class="fa fa-check fa-lg green"></i>', $txt['permissions_post_moderation_allow'], '</li>
									<li><i class="fa fa-warning fa-lg yellow"></i>', $txt['permissions_post_moderation_moderate'], '</li>
									<li><i class="fa fa-minus-circle fa-lg red"></i> ', $txt['permissions_post_moderation_disallow'], '</li>
								</ul>
		...
		echo '
									...
									<tr class="windowbg">
										...
										<th><i class="fa fa-warning fa-lg yellow"></i></th>
										<th><i class="fa fa-minus-circle fa-lg red"></i></th>
										<th><i class="fa fa-check fa-lg green"></i></th>
										<th><i class="fa fa-warning fa-lg yellow"></i></th>
										<th><i class="fa fa-minus-circle fa-lg red"></i></th>
										<th><i class="fa fa-check fa-lg green"></i></th>
