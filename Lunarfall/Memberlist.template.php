...
function template_main()
{
		...
		if ($column['selected'])
			echo '
					<th scope="col" class="', $key, isset($column['class']) ? ' ' . $column['class'] : '', ' selected" style="width: auto;"' . (isset($column['colspan']) ? ' colspan="' . $column['colspan'] . '"' : '') . '>
						<a href="' . $column['href'] . '" rel="nofollow">' . $column['label'] . '<i class="fa fa-sort-' . $context['sort_direction'] . ' fa-lg"></i></a></th>';
	...
	if (!empty($context['members']))
	{
		...
		if (!isset($context['disabled_fields']['website']))
			echo '
					<td class="centertext website_url">', $member['website']['url'] != '' ? '<a href="' . $member['website']['url'] . '" target="_blank" class="new_win"><i class="fa fa-globe fa-lg" title="' . $member['website']['title'] . '"></i></a>' : '', '</td>';
