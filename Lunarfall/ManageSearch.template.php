...
function template_modify_weights()
{
	...
	<form id="admin_form_wrapper" action="', $scripturl, '?action=admin;area=managesearch;sa=weights" method="post" accept-charset="', $context['character_set'], '">
		...
		<div class="windowbg">
			<dl class="settings">
				<dt>
					<a href="', $scripturl, '?action=helpadmin;help=search_weight_frequency" onclick="return reqOverlayDiv(this.href);" class="help" title="', $txt['help'], '"><i class="fa fa-question-circle fa-lg"></i></a><label for="weight1_val">
				...
				<dt>
					<a href="', $scripturl, '?action=helpadmin;help=search_weight_age" onclick="return reqOverlayDiv(this.href);" class="help" title="', $txt['help'], '"><i class="fa fa-question-circle fa-lg"></i></a>
				...
				<dt>
					<a href="', $scripturl, '?action=helpadmin;help=search_weight_length" onclick="return reqOverlayDiv(this.href);" class="help" title="', $txt['help'], '"><i class="fa fa-question-circle fa-lg"></i></a>
				...
				<dt>
					<a href="', $scripturl, '?action=helpadmin;help=search_weight_subject" onclick="return reqOverlayDiv(this.href);" class="help" title="', $txt['help'], '"><i class="fa fa-question-circle fa-lg"></i></a>
				...
				<dt>
					<a href="', $scripturl, '?action=helpadmin;help=search_weight_first_message" onclick="return reqOverlayDiv(this.href);" class="help" title="', $txt['help'], '"><i class="fa fa-question-circle fa-lg"></i></a>
				...
				<dt>
					<a href="', $scripturl, '?action=helpadmin;help=search_weight_sticky" onclick="return reqOverlayDiv(this.href);" class="help" title="', $txt['help'], '"><i class="fa fa-question-circle fa-lg"></i></a>
